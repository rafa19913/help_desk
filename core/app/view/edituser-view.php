...
<div class="row">
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
      <input type="text" name="lastname" value="<?php echo $user->apellidos;?>" required class="form-control" id="lastname" placeholder="Apellido">
    </div>
  </div>
  <div class="form-group">
...
<div class="checkbox">
    <label>
      <input type="checkbox" name="is_admin" <?php if($user->administrador){ echo "checked";}?>> 
    </label>
  </div>
    </div>
  </div>
